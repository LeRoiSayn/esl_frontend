...
export default function FinanceReports() {
  ...
  const handleGlobal = async () => {
    ...
    try {
      ...
      if (!openReport('Rapport Financier Global', "Rapport Financier Global — Vue d'ensemble des Revenus", body)) {
  ...
  const handleStudents = async () => {
    ...
    try {
      ...
      if (!openReport('Rapport Financier par Étudiant', 'État des Frais de Scolarité — Tous les Étudiants', body)) {
        toast.error('Autorisez les pop-ups pour afficher le rapport')
      }
    } catch {
  ...
  const handleFeeTypes = async () => {
    ...
    try {
      ...
      if (!openReport('Rapport par Type de Frais', 'Taux de Recouvrement par Catégorie de Frais', body)) {
        toast.error('Autorisez les pop-ups pour afficher le rapport')
      }
    } catch {
